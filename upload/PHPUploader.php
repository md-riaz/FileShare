...
class PHPUploader {
	...
	function checkMIMEType($tmp_name)
	{
		// Check MIME Type by yourself.
		$finfo = new finfo(FILEINFO_MIME_TYPE);
		if (!in_array($finfo->file($tmp_name), $this->mimetypes, true)) {
			return false;
		}
